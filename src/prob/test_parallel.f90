program postprocess
    ...
    ! call ddx(u,v)
    ! if (master) print*,"Maximum du/dx = ",MAXVAL(v(ax1:axn,ay1:ayn,az1:azn))
    ! if (master) print*,"Minimum du/dx = ",MINVAL(v(ax1:axn,ay1:ayn,az1:azn))

    ! call ddy(u,v)
    ! if (master) print*,"Maximum du/dy = ",MAXVAL(v(ax1:axn,ay1:ayn,az1:azn))
    ! if (master) print*,"Minimum du/dy = ",MINVAL(v(ax1:axn,ay1:ayn,az1:azn))
